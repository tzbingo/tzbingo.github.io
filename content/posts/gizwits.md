+++
title = '用MicroBlocks重新打造机智云开发板的物联功能'
date = 2026-01-24T17:02:49+08:00
draft = false
+++
...
#### 一、ESP8266 机智云开发板简介  
<img src="/images/gizwits/esp8266_gizwits_board0.jpg" style="width:45%;">
<img src="/images/gizwits/esp8266_gizwits_board1.jpg" style="width:45%;">
<img src="/images/gizwits/esp8266_gizwits_board2.jpg" style="width:70%;">

&emsp;&emsp;该板是安信可于2017年前后推出的，它基于ESP8266研发，板载1颗三色RGB LED，光敏电阻，3.3V LDO电源模块，以及1个轻触按键，目前其价格十分便宜，大概10元左右。 

![](/images/gizwits/esp8266_gizwits_board3.png)

其官方原理图([下载](https://docs.ai-thinker.com/_media/esp8266/boards/gizwits/sch.7z))如下：

![](/images/gizwits/esp8266_gizwits_sch.png "原理图")  
...
![](/images/gizwits/MicroBlocks-AdvMenu.png "显示高级积木 升级ESP固件")
等待烧写完成后一般会自动连接(USB图标背景为绿色)开发板。若未连接，则选择“连接”菜单进行连接。   
![](/images/gizwits/MicroBlocks-USB.png "USB串口连接")
...
![](/images/gizwits/esp8266_pins.png "引脚对应关系")  
 
&emsp;&emsp;因为引脚6、7、8分别接绿、蓝、红灯，因此可以通过简单的1-3循环再加5即可控制RGB LED。    

![](/images/gizwits/RgbLed_Test.png "按键控制彩灯")    
...
![](/images/gizwits/boardcastRgb.png "收发消息控制彩灯")  
...
![](/images/gizwits/mqtt-server.png "物联数据中台")
...
for i in range(10):
    ...
    time.sleep(3)
```
![](/images/gizwits/mqtt-test.png "测试MQTT服务器")
再用如下代码来测试物联网数据的订阅。
```python
import siot,time,random
srv="121.5.75.157"
...
while True:
    ...
    time.sleep(3)
```
![](/images/gizwits/mqtt-pub-light.png "环境光强发布到物联中台")
至此，我们的物联网探秘告一段落了。    
#### 题外的话
